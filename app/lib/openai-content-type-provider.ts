...
Assess voice and provenance independently in each language. Institutional first-person advocacy, calls to support an institution's proposal or campaign, and an explicit statement that the text was issued by that institution are strong press_release signals—even when the text does not use the English words "press release." Do not reinterpret that supplied institutional communication as independent reporting because another translation adds reporting or context.
